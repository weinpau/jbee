package com.MAVLink;
        ...
        import com.MAVLink.quantocopter.*;
        ...
        */
		...
		switch (msgid) {
			...
			return  new msg_debug(this);
                        		...
                        		case msg_register_access.MAVLINK_MSG_ID_REGISTER_ACCESS:
			return  new msg_register_access(this);
            		case msg_register_module.MAVLINK_MSG_ID_REGISTER_MODULE:
			return  new msg_register_module(this);
            		case msg_unregister_module.MAVLINK_MSG_ID_UNREGISTER_MODULE:
			return  new msg_unregister_module(this);
            		case msg_register_result.MAVLINK_MSG_ID_REGISTER_RESULT:
			return  new msg_register_result(this);
            		case msg_message_result.MAVLINK_MSG_ID_MESSAGE_RESULT:
			return  new msg_message_result(this);
            		case msg_performance_msg.MAVLINK_MSG_ID_PERFORMANCE_MSG:
			return  new msg_performance_msg(this);
            		case msg_performance_msg_names.MAVLINK_MSG_ID_PERFORMANCE_MSG_NAMES:
			return  new msg_performance_msg_names(this);
